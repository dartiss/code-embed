...
<img src="https://ps.w.org/simple-embed-code/assets/icon.svg" width=128px align="left" style="padding: 0 20px 20px 0;">Code Embed allows you to embed code – JavaScript, CSS and HTML primarily – in a post. This is incredibly useful for embedding video, etc., when required and is used, among others, by Mozilla.
